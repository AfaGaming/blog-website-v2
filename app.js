...
app.get("/posts/:postId", function(req, res){
  const postRequestedId = req.params.postId;

  Post.findOne({_id: postRequestedId}).then(postFound => res.render("post", {title: postFound.title, content: postFound.content})).catch(err => console.log(err));
  });
